...
import img13 from "./images/minimalist-img-5_a1455f0b-6b39-4c34-a1ce-ff3aa62e53af_1024x1024@2x.jpg";
import { Col, Container, Row } from "react-bootstrap";
import { faHeart } from "@fortawesome/free-solid-svg-icons";
import { Link } from "react-router-dom";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";

function Womenproduct13() {
  return (
    <>
      <Container className="productdetails">
        <Row>
          <Col xl={4} lg={6} md={12} sm={12}>
            <img src={img13} className="imgdet" />
          </Col>
